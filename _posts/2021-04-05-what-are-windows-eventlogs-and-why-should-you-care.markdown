...
> Much more information gets available when properly setting up eventlogs for forensic analysis. Then these logs can be your best friend when tracking changes made to a windows system and investigating an attackers work. 
